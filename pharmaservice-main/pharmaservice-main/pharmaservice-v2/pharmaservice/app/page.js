    ...
    <div style={{ fontFamily:"'Arsenal',sans-serif", color:navy, background:cream }}>
      ...
      <nav style={{
        ...
        <a href="/" style={{ textDecoration:"none", display:"flex", alignItems:"center" }}>
          <img src="/img/psc_logo_2025.png" alt="Pharma Service Co." style={{ height:40, width:"auto", display:"block" }} />
        </a>
      ...
      <footer className="footer-grid" style={{ background:"#060e1a", padding:"60px 80px", display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:60, borderTop:"1px solid rgba(248,245,240,0.05)" }}>
        <div>
          <a href="/" style={{ textDecoration:"none", display:"block", marginBottom:16 }}>
            <img src="/img/psc_logo_2025.png" alt="Pharma Service Co." style={{ height:36, width:"auto", display:"block" }} />
          </a>
